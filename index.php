...
<body>
    ...
    <section id="New">
        ...
        <div class="container px-5 mx-auto" style="margin-bottom: 100px;">
            <h2 class="m-8 font-medium text-6xl text-center border-t-2" style="color: rgb(0, 167, 245);">
                New Arrived
            </h2>
        </div>
    </section>
    ...
    <center><hr style="border-color: black; border-style: solid; box-shadow: 0px 20px 50px rgba(0, 0, 0, 1); margin-top: 50px; width: 90%"></center>
    <section id="Adventure">
        </div>

        <div class="container px-5 mx-auto" style="margin-bottom: 100px;">
            <h2 class="text-gray-400 m-8 font-medium text-6xl text-center border-t-2 text-red-800" style="color: rgb(0, 167, 245);" >
                Adventure
            </h2>
        </div>
    </section>
