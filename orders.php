...
<section class="placed-orders">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <?php if($fetch_book['payment_status'] == 'completed'){ ?>
            <p>Get your book: <button style="padding: 10px 30px;background-color:rgb(15, 156, 221);color: white">Download</button></p>
         <?php }else{ ?> 
            <p>Get your book: <i style="color: red;font-size:medium">Wait until payment is completed</i></p>
         <?php } ?>
