...
<section class="edit-product-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p style="margin-top: 20px;color:black;font-size:small;"><b style="font-size: medium;">Update Book Picture:</b> .png, .jpg</p>
      <input type="file" class="box" name="update_image" accept="image/jpg, image/jpeg, image/png">
      <p style="margin-top: 20px;color:black;font-size:small;"><b style="font-size: medium;">Update Book File:</b> .pdf, .docx, .txt</p>
